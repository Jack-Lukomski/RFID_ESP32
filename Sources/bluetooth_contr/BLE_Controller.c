...
#define GATTS_DEMO_CHAR_VAL_LEN_MAX 0x200 // may need to change

#define PREPARE_BUF_MAX_SIZE 1024 // may need to change

static uint8_t char_init_str[] = {0x11, 0x22, 0x33};
static esp_gatt_char_prop_t a_property = 0;

static esp_attr_value_t gatts_demo_char1_val = {
    .attr_max_len = GATTS_DEMO_CHAR_VAL_LEN_MAX,
    .attr_len = sizeof(char_init_str),
    .attr_value = char_init_str,
};
...
// volatile uint16_t* scanned_RFID_TIDS; //in main, need to dynamically change
// size of array
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event,
  ...
  case ESP_GATTS_WRITE_EVT: {
    ...
    if (!param->write.is_prep) {
      if (param->read.handle == 44) { // receive from website first half !!!
        ...
        // esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, 42,
        // //dont know what char handle should be this should work
  ...
  case ESP_GATTS_CREATE_EVT:
    // Add send characteristic (handle: 42)
    ...
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 =
        GATTS_SEND_BADGE_FIRST_CHAR_UUID;
    ...
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 =
        GATTS_RECIEVE_FIRST_BADGE_CHAR_UUID;
    add_char_ret =
        esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                               &gl_profile_tab[PROFILE_A_APP_ID].char_uuid,
                               ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
    ...
    // Add scan badge characteristic (handle: 46)
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 =
        GATTS_SCAN_BADGE_CHAR_UUID;
    add_char_ret =
        esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                               &gl_profile_tab[PROFILE_A_APP_ID].char_uuid,
                               ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
    ...
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 =
        GATTS_SEND_BADGE_SECOND_CHAR_UUID;
    add_char_ret =
        esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                               &gl_profile_tab[PROFILE_A_APP_ID].char_uuid,
                               ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
    ...
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
    gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 =
        GATTS_RECIEVE_SECOND_BADGE_CHAR_UUID;
    add_char_ret =
        esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle,
                               &gl_profile_tab[PROFILE_A_APP_ID].char_uuid,
                               ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
