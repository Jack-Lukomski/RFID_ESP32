...
static uint8_t* scanned_RFID_TIDS; //in main, need to dynamically change size of array
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        // rsp.attr_value.value[0] = 0x80;
        // rsp.attr_value.value[1] = 0x08;
        // rsp.attr_value.value[2] = 0x56;
        // rsp.attr_value.value[3] = 0x78;
        // rsp.attr_value.value[4] = 0x99;
